...
void inicio(){
    ...
    printf("Ao acordar você se depara com uma pessoa, ela explica rapidamente a situação e diz que você morreu e tem a opção de reencarnar num mundo de fantasia, onde você poderá ser um aventureiro e entre outras coisas ou poderia apenas continuar dormindo no vazio.\n");
    printf("1-Reencarnar\n");
...
void continuar_morto(){
    printf("você permanece dormindo o vazio até o fim dos tempos.\n");
}
//função caso deseje reencarnar no novo mundo
void acordar_novo_mundo()
{
    int opcao;
    printf("ao acordar no seu novo mundo, você procura por informações de como iniciar sua vida de aventureiro e quais caminhos você poderá seguir.\n");
    printf("depois de pedir informações, você chega na guilda dos aventureiros onde a recepcionista explica um pouco da vida de um aventureiro, caçadores ou especialistas em magia porém e comum que grande parte deles se aventuram nas dungeons do Mundo de Orario, ela oferece 3 tipos de armas para auxiliar no começo da sua aventura.\n");
    printf("1 - espada\n");
    printf("2 - arco\n");
    printf("3 - cajado\n");
    scanf("%d",&opcao);
    ...
    if (opcao == 1){
        printf("De posse da espada sua aventura dá início, recolhendo missões e acumulando dinheiro para que você possa melhorar seus equipamentos e aprender novas habilidades, numa das missões você precisa explorar uma dungeon porém e recomendado que você faça em grupo devido a quantidade de monstros no local.\n");
        int escolha_dungeon;
        printf("1-Fazer sozinho e tentar a sorte\n");
...
void entrar_sozinho(){
    printf("ao adentrar sozinho dentro da dungeon, devido a quantidade de monstro seu personagem acaba se encurralando e sendo morto pela quantidade de monstros dentro da caverna.\n");
...
void luta_boss(){
    ...
    printf("Dentro da dungeons sua equipe vai limpando os monstros com facilidade devido a grande quantidade de dano que seu grupo possui, avançando de modo frenético. Chegando numa sala onde um Minotauro aguarda, ele possui duas espadas e mais ou menos uns 3m.\n");
...
//função estrategia(espada)
void estrategia_espada(){
    int decisao_item;
    printf("Ao observar que o boss e grande logo percebe-se que seus movimentos podem ser lentos, então decide que irão cercá-lo e deixar que os magos iniciem o ataque para que distraia o chefe, após isso vocês iram avançar desviando dos ataques e contra-atacando sempre que uma brecha aparecer.\n");
    printf("Você consegue desferir um golpe na cabeça do boss, fazendo com quem ele recue rapidamente, nesse momento você grita para sua equipe continuar atacando visto que ele está mais vulnerável, após um tempo atacando, você derrota o boss com um ataque elemental na sua espada, finalizando assim o boss. Com isso um equipamento raro e dropado e você decide o que fará com ele.\n");
...
//função caso escolha so terminar a dungeon
void terminar_dungeon() {
...
//Funções da historia de caçador.

//função para escolha do destino do caçador.
void escolha_caca(){
    int escolha_cacada;
    printf("Ao escolher seu arco, você recebe um guia de caça e das espécies que habitam as regiões do mundo de orario e seus níveis de raridade, porém para que você cace novas espécies precisa aprender técnicas melhores então decide começar com criaturas mais fáceis.\n");
...
// não participar da caçada no momento.
void nao_participar(){
    int escolha;
...
void cacada_selva(){
    int escolha;
    printf("Indo atras do grupo, você usa suas habilidades de rastreamento para que você possa achar o caminho até a zona que monstro se encontra, pois você acabou se atrasando e o grupo partiu sem você.\n");
    printf("Ao chegar no local, se depara com o time enfrentando uma besta gigante de presas e garras extremamente afiadas, ao dar uma olhada ao redor percebe que tem algumas pessoas abatidas e fica a duvida se ajuda os caídos ou parte para a batalha na esperança de derrotar a besta e ficar com o couro.\n");
...
//função se juntar a linha de frente.
void juntar_batalha(){
    int skill;
...
//função caso decida ajudar os caidos
void ajudar(){
    int skill;
...
void usar_habilidade(){
    ...
    printf("2-	Craftar e guardar para você mesmo.\n");
...
void flecha_normal(){
    printf("Usa flechas normais acabam não fazendo efeito na besta, fazendo que com que ela foque em você, deferindo um golpe muito forte na sua cabeça acabando com sua vida ali mesmo.\n");
    printf("\n");
    printf("****FIM****");
}
//final alternativo, centro de treinamento.
void criar_escola(){
    printf("ao vender o couro no market, você consegue muito dinheiro, investindo assim num campo de treinamento para aqueles que desejam aprender habilidades de caça e se torna um grande caçador no mundo de orario.\n")/
    printf("\n");
    printf("****FIM****");

}
//final canonico, continuar caçando
void continuar_cacada(){
...
//função caso decida ir para a linha de frente.
...
void ler_escuridao(){
    ...
    printf("encontrando quase no final sobre e ela explica que anksheram e uma maldição ao qual toda vida ao redor daquele que está amaldiçoado e subtraída e não existe uma forma de quebra a maldição e só resta o usuário conviver eternamente com aquilo.\n");
...
//caçar monstro com a magia nova
void cacar_monstros2(){
